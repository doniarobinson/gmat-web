...
The shipped practice screen does **not** expose progressive hints yet; `Attempt.hintsUsed` in the data model is reserved for assessment analytics and future UI.
...
- Assessment and practice alike record `hintsUsed` for speed-vs-accuracy and “needed help” signals.
